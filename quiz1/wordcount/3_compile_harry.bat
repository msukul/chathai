...
start cmd.exe /k "bin\windows\kafka-run-class.bat org.apache.kafka.streams.examples.harrycount.HarryCount"
@REM start cmd.exe /k "bin\windows\kafka-run-class.bat org.apache.kafka.streams.examples.harrycount.HarryCountTransformer"
